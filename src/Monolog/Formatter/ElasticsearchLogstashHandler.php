...
class ElasticsearchLogstashHandler extends AbstractProcessingHandler
{
    ...
    public function __construct(string $endpoint = 'http://elasticsearch:9200', string $index = 'monolog', HttpClientInterface $client = null, int $level = Logger::DEBUG, bool $bubble = true)
    {
